...
const DepthCarousel = ({
  ...
  useEffect(() => {
    ...
    if (!el) return;
    // Disabled wheel navigation - only use buttons
    return () => {};
  }, []);
      ...
      <div className="depth-carousel__stage" ref={stageRef}>
        {data.map((item, i) => (
          ...
          >
            ...
            />
            <div className="depth-carousel__card-content">
              {item.title && (
                <div className="depth-carousel__card-title">
                  {item.title}
                </div>
              )}
              {item.link && (
                <button 
                  className="depth-carousel__card-button"
                  onClick={(e) => {
                    e.stopPropagation();
                    onCardClick?.(i, item);
                  }}
