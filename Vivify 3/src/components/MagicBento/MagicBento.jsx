...
export const DEFAULT_GLOW_COLOR = '40, 101, 235';
...
export const GlobalSpotlight = ({
  ...
  useEffect(() => {
    ...
    spotlight.className = `global-spotlight ${className}`.trim();
    ...
    const handleMouseMove = e => {
      ...
      const targetOpacity =
        minDistance <= proximity
          ? (blendMode === 'screen' ? 0.8 : 0.45)
          : minDistance <= fadeDistance
            ? ((fadeDistance - minDistance) / (fadeDistance - proximity)) * (blendMode === 'screen' ? 0.8 : 0.45)
            : 0;
  ...
  }, [gridRef, disableAnimations, enabled, spotlightRadius, glowColor, blendMode, className]);
